document.addEventListener('DOMContentLoaded', function() {
    ...
    initContactForm(); // دالة واحدة للمرسلات
});
...
function initTypingEffect() {
    ...
    const phrases = ['Web Developer', 'Cybersecurity Student', 'Problem Solver', 'Code Explorer', 'Innovator'];
...
function initContactForm() {
    // استخدمي مفتاح واحد فقط (تأكدي أيهما الصحيح في حسابك)
